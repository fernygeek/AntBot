...
public class AntBotPanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        btnCreate.addActionListener(e -> createAntBot());
        btnUpdate.addActionListener(e -> updateAntBot());
        btnDelete.addActionListener(e -> deleteAntBot());
    ...
    private void loadTableData() {
        try {
            ...
            AntBotBL AntBotBL = new AntBotBL();
            List<AntBotDTO> Relacions = AntBotBL.readAll();
            ...
            for (AntBotDTO Relacion : Relacions) {
                model.addRow(new Object[]{
                        Relacion.getIdAntBot(),
                        Relacion.getSerie(),
                        Relacion.getEstado(),
    ...
    if (nombre != null && !nombre.isEmpty()) {
        try {
            AntBotDTO nuevoRelacion = new AntBotDTO();
            nuevoRelacion.setSerie(nombre);

            AntBotBL AntBotBL = new AntBotBL();
            boolean creado = AntBotBL.create(nuevoRelacion);
    ...
    if (selectedRow != -1) {
        ...
        if (nuevoNombre != null && !nuevoNombre.isEmpty()) {
            try {
                AntBotDTO RelacionActualizado = new AntBotDTO();
                RelacionActualizado.setIdAntBot(RelacionID);
                RelacionActualizado.setSerie(nuevoNombre);

                AntBotBL AntBotBL = new AntBotBL();
                boolean actualizado = AntBotBL.update(RelacionActualizado);
    ...
    if (selectedRow != -1) {
        ...
        if (option == JOptionPane.YES_OPTION) {
            ...
            try {
                AntBotBL AntBotBL = new AntBotBL();
                boolean eliminado = AntBotBL.delete(RelacionID);
